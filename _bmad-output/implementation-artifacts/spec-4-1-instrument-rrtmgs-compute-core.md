...
**Profiling method gotchas (AD-2, `perf`+Nsight) and the Automake build-parallelism hazard hit during this story's verification are reusable knowledge for future profiling/build stories — see `project-context.md`'s Development Workflow Rules, HPC Profiling Method Gotchas.**
