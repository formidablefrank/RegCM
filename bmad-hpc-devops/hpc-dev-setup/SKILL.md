---
name: "hpc-dev-setup"
description: Sets up RegCM5 HPC DevOps module in a project. Use when the user requests to 'install hpc-dev module', 'configure RegCM5 HPC DevOps', or 'setup RegCM5 HPC DevOps'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/hpc-dev/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code hpc-dev
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code hpc-dev --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
