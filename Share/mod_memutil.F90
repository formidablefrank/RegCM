...
module mod_memutil
  ...
  subroutine assignp3d4_l(a,b,k)
    ...
    b(lbound(a,1):, lbound(a,2):, lbound(a,3):) => a(:,:,:,k)
  ...
  subroutine assignp4d5_l(a,b,n)
    ...
    b(lbound(a,1):, lbound(a,2):, lbound(a,3):, lbound(a,4):) => a(:,:,:,:,n)
  ...
  subroutine assignp5d_l(a,b)
    ...
    b(lbound(a,1):, lbound(a,2):, lbound(a,3):, &
  ...
  subroutine remappnt4_r8(a,b)
    ...
    b(lbound(a,1):, lbound(a,2):, 1:, lbound(a,4):) => a
