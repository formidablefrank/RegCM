---
name: "hpc-test-setup"
description: Sets up RegCM5 HPC Test Architect module in a project. Use when the user requests to 'install hpc-test module', 'configure RegCM5 HPC Test Architect', or 'setup RegCM5 HPC Test Architect'.
---
...
3. Check for per-module configuration at `{project-root}/_bmad/hpc-test/config.yaml` and `{project-root}/_bmad/core/config.yaml`. If either file exists:
...
python3 ./scripts/merge-help-csv.py --target "{project-root}/_bmad/module-help.csv" --source ./assets/module-help.csv --legacy-dir "{project-root}/_bmad" --module-code hpc-test
```
...
```bash
python3 ./scripts/cleanup-legacy.py --bmad-dir "{project-root}/_bmad" --module-code hpc-test --also-remove _config --skills-dir "{project-root}/.claude/skills"
```
